...
<main>
<?php
$pdo = new PDO('mysql:host=mysql207.phy.lolipop.lan;dbname=LAA1417869-product;charset=utf8','LAA1417869','Pass2201117');
$sql = "SELECT * FROM user_acount WHERE user_id =?";
$ps = $pdo->prepare($sql);
$ps->bindValue(1,$_SESSION['uid'],PDO::PARAM_INT);
$ps->execute();
$data=$ps->fetchAll();
    foreach($data as $row){
      echo '<div id="te">';
...
<form action="cart3.php" method="post">
    ...
    <button type="submit" class="btn-sm btn-blue">購入</button>
</form>
