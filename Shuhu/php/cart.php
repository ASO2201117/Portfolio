...
<nav id="header-menu">
    <ul>
        ...
        <li><a href="shopping.php"">商品<i class="fas fa-image"></i></a></li>
...
<?php endforeach; ?>
    ...
    <div class="cart-btn">
        <button type="button"  class="btn-sm btn-blue" onclick="location.href='login_form.php'">ログイン</button>
    </div>
    </div>
    </div>
    </div>
