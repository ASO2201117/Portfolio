...
<div align="center">
    <div id="app">
        <div class="form-area___name">
            <p>ユーザー名</p>
            <input type="text" name="mei" autocomplete="off" v-model="name"/>
            <p class="error" v-if="isInValidName">ユーザー名は10文字以内で入力してください</p>
        </div>
...
<div align="center">
    <div id="app">
        ...
        <div class="form-area__mailaddress">
            <p>メールアドレス</p>
            <input type="text" name="address" autocomplete="off" v-model="mailaddress"/>
            <p v-if="isInValidMailaddress" class="error">メールアドレスを正しく入力してください</p>
        </div>
        <div class="form-area__password">
            <p>パスワード</p>
            <input type="password" name="pass" autocomplete="off" v-model="password"/>
            <p v-if="isInValidPassword" class="error">パスワードは5文字以上で入力してください</p>
        </div>
        <div class="form-area__address">
            <p>住所</p>
            <input type="address" name="zyusyo" autocomplete="off" v-model="address"/>
        </div>
        <div class="form-area__tel">
        <p>電話番号</p>
        <input type="tel" name="bangou" autocomplete="off" v-model="tel"/>
            <p v-if="isInValidTel" class="error">電話番号を正しく入力してください</p>
        </div>
				<div aligin="center">
